...
const FilmCategory = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Create FormData with all category data
      const categoryFormData = new FormData();
      
      // Add ID for updates
      if (currentCategory) {
        categoryFormData.append('id', currentCategory.id);
      }
      ...
      if (currentCategory) {
        ...
        response = await categoryAPI.updateCategoryWithImage(categoryFormData);
      } else {
        // CREATE new category
        response = await categoryAPI.createCategoryWithImage(categoryFormData);
      }
